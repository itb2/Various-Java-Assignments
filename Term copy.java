...
public class Term implements Comparable<Term> {
	...
	public static class PrefixOrder implements Comparator<Term> {
		...
		public int compare(Term v, Term w) {
			...
			String sub1 = v.myWord.substring(0,Math.min(r, v.myWord.length()));
			String sub2 = w.myWord.substring(0,Math.min(r, w.myWord.length()));
			if(sub1.compareTo(sub2)> 0) return 1;
			if(sub1.compareTo(sub2)< 0) return -1;
			return 0;
	...
	public static class ReverseWeightOrder implements Comparator<Term> {
		public int compare(Term v, Term w) {
			...
			if (w.myWeight > v.myWeight) return 1;	
			return 0;
		}
	}
